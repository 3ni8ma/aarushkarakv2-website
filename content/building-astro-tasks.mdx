export const title = "Building astro-tasks: A Python CLI Developer Dashboard"
export const date = "July 27, 2026"
export const tags = ["Python", "CLI", "PyPI", "GitHub API", "WakaTime"]
export const repo = "https://github.com/3ni8ma/astro-tasks"

## Overview

astro-tasks is a modular Python CLI that aggregates GitHub notifications, tracks git health stats, and provides a unified developer dashboard. The tool wraps the GitHub API, local git analysis, and terminal UI rendering into a single pip-installable package.
